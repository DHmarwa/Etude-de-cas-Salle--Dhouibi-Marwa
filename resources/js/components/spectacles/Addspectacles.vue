  ...
  <div class="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
    ...
    <form @submit.prevent="addspectacles">
      <div class="row">
        ...
        <div class="col-md-6 ms-auto">
          <label for="date_spectacle" class="form-label">Date Spectacles</label>
          <input type="text" class="form-control" id="date_spectacle" v-model="spectacle.datespectacle">
        </div>

        <!--<div class="col-md-6 ms-auto">
          <label for="categorie" class="form-label">Catégorie</label>
          <input type="text" class="form-control" id="categorieID" v-model="article.scategorieID">
        </div>-->
